...
export const scentFamilies = [
    {
        ...
        products: ['Nebula Gold', 'Shadow Rift', 'Eternal Ember', 'Ember Noir', 'Ember Royale', 'Nightfall Ember', 'Mystic Oud', 'Ancient Ember', 'Nightfall Rose', 'Crystal Dawn', 'Petal Sphere']
    },
    {
        id: 'fresh-citrus',
        name: 'Fresh & Citrus',
        ...
        products: ['Solstice Aura', 'Solar Prism', 'Aegean Star', 'Azure Pulse', 'Radiant Eclipse', 'Solar Apex', 'Frost Zenith', 'Starborn Drift']
    },
    {
        id: 'floral-romantic',
        ...
        products: ['Lunar Silk', 'Celestial Rose', 'Lunar Bloom', 'Blossom Ray', 'Aurora Bloom', 'Stellar Velvet', 'Rose Nebula', 'Solar Bloom', 'Stellar Bloom', 'Fire Blossom', 'Flora Nova', 'Astral Wonder', 'Golden Stardust', 'Velvet Cosmos']
    },
    {
        id: 'oriental-spicy',
        name: 'Oriental & Spicy',
        ...
        products: ['Ember Pulse', 'Volcanic Crown', 'Nightforge', 'Ember Noir', 'Solar Noir', 'Midnight Aura', 'Amber Radiance', 'Nightfall Ember']
    },
    {
        ...
        products: ['Helios Peak', 'Solar Prism', 'Serpent Star', 'Cosmic Noir', 'Aegean Surge', 'Ember Strike', 'Mystic Oud', 'Solar Apex']
    },
    {
        ...
        products: ['Frost Zenith', 'Tidal Origin', 'Azure Pulse', 'Radiant Eclipse', 'Oceanic Halo', 'Cloud Meadow', 'Aegean Surge', 'Solstice Aura']
    }
];
...
export const genderClassification = {
    Feminine: [
        'Lunar Silk', 'Starlit Femme', 'Celestial Rose', 'Lunar Bloom', 'Ember Noir',
        'Solar Noir', 'Blossom Ray', 'Midnight Petal', 'Aurora Bloom', 'Stellar Velvet',
    ...
    Masculine: [
        ...
        'Radiant Eclipse', 'Ember Strike', 'Nightfall Ember', 'Mystic Oud', 'Solar Apex'
    ],
    Unisex: [
        'Nebula Gold', 'Solstice Aura', 'Tidal Origin', 'Aether Santal', 'Oceanic Halo'
    ]
};
...
export const occasionClassification = {
    Daytime: [
        ...
        'Blossom Ray', 'Aurora Bloom', 'Stellar Velvet', 'Solar Prism', 'Oceanic Halo', 'Velvet Cosmos'
    ],
    Evening: [
        'Nebula Gold', 'Lunar Silk', 'Ember Pulse', 'Eternal Ember', 'Shadow Rift',
        'Nightforge', 'Solar Noir', 'Ember Noir', 'Ember Royale', 'Midnight Aura',
        'Mystic Oud', 'Nightfall Ember', 'Ancient Ember', 'Amber Radiance'
    ],
    'Special Occasions': [
